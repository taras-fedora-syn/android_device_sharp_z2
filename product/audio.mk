...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/smartpa_params/coldboot.patch:system/etc/smartpa_params/coldboot.patch \
    $(LOCAL_PATH)/smartpa_params/ly.config:system/etc/smartpa_params/ly.config \
    $(LOCAL_PATH)/smartpa_params/ly.speaker:system/etc/smartpa_params/ly.speaker \
    $(LOCAL_PATH)/smartpa_params/ly_0_0_ly.eq:system/etc/smartpa_params/ly_0_0_ly.eq \
    $(LOCAL_PATH)/smartpa_params/ly_0_0_ly.preset:system/etc/smartpa_params/ly_0_0_ly.preset \
    $(LOCAL_PATH)/smartpa_params/speech_ly_0_0_ly.eq:system/etc/smartpa_params/speech_ly_0_0_ly.eq \
    $(LOCAL_PATH)/smartpa_params/speech_ly_0_0_ly.preset:system/etc/smartpa_params/speech_ly_0_0_ly.preset \
    $(LOCAL_PATH)/smartpa_params/TFA9890_N1C3_1_5_1.patch:system/etc/smartpa_params/TFA9890_N1C3_1_5_1.patch \
